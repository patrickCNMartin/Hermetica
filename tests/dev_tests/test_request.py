...
class TestPagination:
    ...
    def test_walks_multiple_pages(self, list_items):
        ...
        responses.add(
            responses.GET, PROTOCOLS_URL, json={"items": list_items(3, start=11)}
        )
    ...
    def test_stops_at_max_page(self, list_items):
        ...
        result = fetch_protocol_list(PROTOCOLS_URL, HEADERS, page_size=10, max_pull=5)
...
class TestEnvelopeDrivenPagination:
    ...
    def test_walk_starts_at_page_zero(self, list_items):
        ...
        responses.add(responses.GET, PROTOCOLS_URL, json=paged(list_items(1), None, 1))
    ...
    def test_follows_next_page_not_page_length(self, list_items):
        ...
        responses.add(
            responses.GET, PROTOCOLS_URL, json=paged(list_items(10), None, 10)
        )
    ...
    def test_continues_on_short_page_when_next_page_is_set(self, list_items):
        ...
        responses.add(
            responses.GET, PROTOCOLS_URL, json=paged(list_items(1), "?page_id=1", 2)
        )
        responses.add(
            responses.GET, PROTOCOLS_URL, json=paged(list_items(1, start=2), None, 2)
        )
    ...
    def test_count_mismatch_retries_once_then_succeeds(self, list_items):
        ...
        responses.add(
            responses.GET, PROTOCOLS_URL, json=paged(list_items(1), None, 2)
        )  # 1 of 2 -> retry
        responses.add(responses.GET, PROTOCOLS_URL, json=paged(list_items(2), None, 2))
    ...
    def test_capped_walk_is_not_verified(self, list_items):
        ...
        responses.add(
            responses.GET, PROTOCOLS_URL, json=paged(list_items(10), "?page_id=1", 999)
        )

        result = fetch_protocol_list(PROTOCOLS_URL, HEADERS, page_size=10, max_pull=1)
        assert len(result) == 10
    ...
    def test_resumed_walk_is_not_verified(self, list_items):
        ...
        responses.add(
            responses.GET, PROTOCOLS_URL, json=paged(list_items(1), None, 999)
        )

        result = fetch_protocol_list(PROTOCOLS_URL, HEADERS, page_size=10, page_id=5)
        assert len(result) == 1
    ...
    def test_endpoint_without_pagination_still_works(self, list_items):
        ...
        responses.add(responses.GET, PROTOCOLS_URL, json={"items": list_items(10)})
        responses.add(
            responses.GET, PROTOCOLS_URL, json={"items": list_items(1, start=11)}
        )
